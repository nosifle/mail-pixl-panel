...
const AuthCard = ({ onCreateAccount, onLogin, isLoading }: AuthCardProps) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <Tabs defaultValue="login" className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <TabsList className="grid w-full grid-cols-2 mb-6 md:col-span-2">
          <TabsTrigger value="login">Вход</TabsTrigger>
          <TabsTrigger value="register">Регистрация</TabsTrigger>
        </TabsList>

        <TabsContent value="register" className="md:col-span-1">
          <Card>
            <CardHeader>
        ...
        <TabsContent value="login" className="md:col-span-1">
          <Card>
            <CardHeader>
